...
{
    [Serializable]
    public struct Int128 : IFormattable, IComparable, IComparable<Int128>, IEquatable<Int128>, ISerializable
    {
        private UInt128 v;
        ...
        public Int128(SerializationInfo info, StreamingContext context)
        {
            var str = info.GetString("int128");
            TryParse(str, out this);
        }

        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            info.AddValue("int128", ToString());
        }
    }
}
